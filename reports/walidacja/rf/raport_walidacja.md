...
* dodatni błąd offset wskazuje, że model utrzymuje alarm średnio o **0,9 dnia dłużej** niż rzeczywisty epizod,
* mediana równa 0 dni dla obu metryk oznacza, że dla znacznej części epizodów granice zdarzeń zostały określone poprawnie.
...
Wnioski:
Model wykrył **85% wszystkich rzeczywistych wezbrań**, co świadczy o wysokiej skuteczności identyfikacji zdarzeń. Jedynie 15% epizodów nie zostało rozpoznanych.
...
Oznacza to, że około **58% dni oznaczonych jako epizodowe było poprawnych**, natomiast około **42% stanowiły fałszywe wskazania**.
...
| **Średnia** | **0,898** | **0,599** | **0,709** | **0,869**    |
